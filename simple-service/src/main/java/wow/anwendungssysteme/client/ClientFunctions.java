...
public class ClientFunctions {
	...
	public static void createUser(String name, int id) {
		...
		Response response = userTarget.request(MediaType.APPLICATION_JSON)
	...
	public static ArrayList<User> getUsers() {
		Invocation.Builder invocationBuilderUsers = allUsersTarget
	...
	public static User getUserById(int id) {
		...
		Invocation.Builder invocationBuilderUser = specificUserTarget
				.request(MediaType.APPLICATION_JSON);
	...
	public static void deleteUserById(int id) {
		specificUserTarget = userTarget.path(Integer.toString(id));
		Response response = specificUserTarget.request(
	...
	public static void createAuction(int id, int creatorId, String title,
			String description, String imgUrl, long endTime) {
		// AuctionDetails(<Titel>, <Beschreibung>, <BildURL>, <Endzeitpunkt>)
		AuctionDetails details = new AuctionDetails(title, description, imgUrl,
				endTime);
	...
	public static void bid(int auctionId, int bidderId, int value) {
		...
		bidTarget = auctionTarget.path(Integer.toString(auctionId)).path(
				"highestBid");
		Response response = bidTarget.request(MediaType.APPLICATION_JSON).post(
				Entity.entity(bid, MediaType.APPLICATION_JSON));
	...
	public static Auction getAuctionById(int auctionId) {
		...
		Invocation.Builder invocationBuilderSpecificAuction = specificAuctionTarget
				.request(MediaType.APPLICATION_JSON);
	...
	public static void updateAuction(int auctionId, String newTitle,
	...
	public static AuctionDetails getAuctionDetailsById(int auctionId) {
		detailTarget = auctionTarget.path(Integer.toString(auctionId)).path(
				"auctionDetails");
		Invocation.Builder invocationBuilderDetails = detailTarget
				.request(MediaType.APPLICATION_JSON);
